...
final class DataValidationTest extends TestCase
{
    ...
    public function testDataVerification(): void
    {
        $result = DataValidation::dataVerification([
            ['transactionDate' => '2015-02-01', 'transactionSize' => 'S', 'transactionCourier' => 'MR'],
            ['transactionDate' => '2015-02-02', 'transactionSize' => 'S', 'transactionCourier' => 'MR'],
            ['transactionDate' => '2015-02-03', 'transactionSize' => 'L', 'transactionCourier' => 'LP'],
            ['transactionDate' => '2015-02-05', 'transactionSize' => 'S', 'transactionCourier' => 'LP'],
            ['transactionDate' => '2015-02-06', 'transactionSize' => 'S', 'transactionCourier' => 'MR'],
            ['transactionDate' => '2015-02-06', 'transactionSize' => 'L', 'transactionCourier' => 'LP'],
            ['transactionDate' => '2015-02-07', 'transactionSize' => 'L', 'transactionCourier' => 'MR'],
            ['transactionDate' => '2015-02-08', 'transactionSize' => 'M', 'transactionCourier' => 'MR'],
            ['transactionDate' => '2015-02-09', 'transactionSize' => 'L', 'transactionCourier' => 'LP'],
            ['transactionDate' => '2015-02-10', 'transactionSize' => 'L', 'transactionCourier' => 'LP'],
            ['transactionDate' => '2015-02-10', 'transactionSize' => 'S', 'transactionCourier' => 'MR'],
            ['transactionDate' => '2015-02-10', 'transactionSize' => 'S', 'transactionCourier' => 'MR'],
            ['transactionDate' => '2015-02-11', 'transactionSize' => 'L', 'transactionCourier' => 'LP'],
            ['transactionDate' => '2015-02-12', 'transactionSize' => 'M', 'transactionCourier' => 'MR'],
            ['transactionDate' => '2015-02-13', 'transactionSize' => 'M', 'transactionCourier' => 'LP'],
            ['transactionDate' => '2015-02-15', 'transactionSize' => 'S', 'transactionCourier' => 'MR'],
            ['transactionDate' => '2015-02-17', 'transactionSize' => 'L', 'transactionCourier' => 'LP'],
            ['transactionDate' => '2015-02-17', 'transactionSize' => 'S', 'transactionCourier' => 'MR'],
            ['transactionDate' => '2015-02-24', 'transactionSize' => 'L', 'transactionCourier' => 'LP'],
            ['2015-02-29', 'CUSPS'],
            ['transactionDate' => '2015-03-01', 'transactionSize' => 'S', 'transactionCourier' => 'MR']
        ], [
            'LP' => [
                'S' => 1.5,
                'M' => 4.9,
    ...
    /**
     * Test the addShipmentPrices method of the DataValidation class
     */
    public function testAddShipmentPrices(): void
    {
        $result = DataValidation::addShipmentPrices([
            ['transactionDate' => '2015-02-01', 'transactionSize' => 'S', 'transactionCourier' => 'MR'],
            ['transactionDate' => '2015-02-02', 'transactionSize' => 'S', 'transactionCourier' => 'MR'],
            ['transactionDate' => '2015-02-03', 'transactionSize' => 'L', 'transactionCourier' => 'LP'],
            ['transactionDate' => '2015-02-05', 'transactionSize' => 'S', 'transactionCourier' => 'LP'],
